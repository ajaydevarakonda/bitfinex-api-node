...
class WSv2 extends EventEmitter {
  ...
  /**
   * @param {string} symbol
   * @param {string} freq - F0, F1 (default F0)
   * @return {boolean} subscribed
   */
  subscribeTrades (symbol, freq = 'F0') {
    return this.managedSubscribe('trades', symbol, { symbol, freq })
  }
   ...
   * @return {boolean} subscribed
   */
  subscribeOrderBook (symbol, freq = 'F0', prec = 'P0', len = '25') {
    return this.managedSubscribe('book', symbol, { symbol, freq, len, prec })
  }
